...
with left:
    ...
    with r1[0]:
        kpi_card("Lden lowered > 1dB (# people)", f"{outputs['homes']:,}", tooltip = "This KPI shows the number of people whose aircraft noise exposure (Lden) decreases by more than 1 decibel compared to the baseline scenario")
    with r1[1]:
        kpi_card("Added value – direct (€m)", f"{outputs['va_direct']:,.1f}",tooltip="This KPI represents the direct economic value added generated by the sector or activity, expressed in millions of euros.")
    with r1[2]:
        kpi_card("Added value – indirect (€m)", f"{outputs['va_indirect']:,.1f}", tooltip="This KPI represents the indirect economic value added generated in the supply chain, expressed in millions of euros.")
    with r1[3]:
        kpi_card("Total passengers (millions)", f"{outputs['total_pax']:.3f}", tooltip="This KPI represents the total number of passengers handled on Schiphol, expressed in millions of passengers per year.")

    with r2[0]:
        kpi_card("Employment – direct (jobs)", f"{outputs['jobs_direct']:,}", tooltip="This KPI represents the number of jobs directly generated by the activities in the Schiphol cluster, measured as the total number of positions (jobs).")
    with r2[1]:
        kpi_card("Employment – indirect (jobs)", f"{outputs['jobs_indirect']:,}", tooltip="This KPI represents the number of jobs indirectly generated by the activities in the Schiphol cluster, measured as the total number of positions (jobs).")
    with r2[2]:
        kpi_card("Freight Cargo volume (M tons)", f"{outputs['total_cargo_freight']:.4f}", tooltip="This KPI represents the total volume of air freight transported by full freight flights, expressed in millions of metric tons per year.")
    with r2[3]:
        kpi_card("Belly Cargo volume (M tons)", f"{outputs['total_cargo_belly']:.3f}", tooltip="This KPI represents the total volume of air freight transported as belly cargo, expressed in millions of metric tons per year.")
